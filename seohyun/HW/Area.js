...
console.log(surfaceAreaCube(5))
console.log(surfaceAreaSphere(5))
console.log(areaRectangle(4, 4))
console.log(areaSquare(4))
console.log(areaTriangle(1.66, 3.44))
console.log(areaParallelogram(5, 6))
console.log(areaTrapezium(5, 12, 10))
console.log(areaCircle(5, 12, 10))
console.log(areaRhombus(12, 10))
console.log(areaTriangleWithAllThreeSides(5, 6, 7))